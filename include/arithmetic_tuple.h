...
namespace ReaK {
    ...
    */  
   template <typename... T>
      arithmetic_tuple<T...> operator +(const arithmetic_tuple<T...>& lhs, const arithmetic_tuple<T...>& rhs) {
		  arithmetic_tuple<T...> result;
		  detail::tuple_add_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>>(result, lhs, rhs);
		  return result;
	       };
    ...
    * \tparam arithmetic_tuple<T...> An arithmetic-tuple type (see is_arithmetic_tuple).
    */  
   template <typename... T>
      arithmetic_tuple<T...> operator -(const arithmetic_tuple<T...>& lhs, const arithmetic_tuple<T...>& rhs) {
		  arithmetic_tuple<T...> result;
		  detail::tuple_sub_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>>(result, lhs, rhs);
		  return result;
	       };
    ...
    */  
   template <typename... T>
      arithmetic_tuple<T...> operator -(const arithmetic_tuple<T...>& lhs) {
		  arithmetic_tuple<T...> result;
		  detail::tuple_neg_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>>(result, lhs);
		  return result;
	       };
    ...
    */  
   template <typename... T>
      arithmetic_tuple<T...>& operator +=(arithmetic_tuple<T...>& lhs, const arithmetic_tuple<T...>& rhs) {
		  detail::tuple_addassign_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>>(lhs, rhs);
		  return lhs;
	       };
   ...
   template <typename... T>
      arithmetic_tuple<T...>& operator -=(arithmetic_tuple<T...>& lhs, const arithmetic_tuple<T...>& rhs) {
		  detail::tuple_subassign_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>>(lhs, rhs);
		  return lhs;
	       };
   ...
   template <typename... T>
      arithmetic_tuple<T...> operator *(const arithmetic_tuple<T...>& lhs, const arithmetic_tuple<T...>& rhs) {
		  arithmetic_tuple<T...> result;
		  detail::tuple_mul_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>>(result, lhs, rhs);
		  return result;
	       };
   ...
   template <typename... T>
      arithmetic_tuple<T...> operator /(const arithmetic_tuple<T...>& lhs, const arithmetic_tuple<T...>& rhs) {
		  arithmetic_tuple<T...> result;
		  detail::tuple_div_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>>(result, lhs, rhs);
		  return result;
	       };
   ...
   template <typename... T, typename Scalar>
      arithmetic_tuple<T...> operator *(const arithmetic_tuple<T...>& lhs, const Scalar& rhs) {
		  arithmetic_tuple<T...> result;
		  detail::tuple_muls_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>,Scalar>(result, lhs, rhs);
		  return result;
	       };
    ...
    */  
   template <typename... T, typename Scalar>
      arithmetic_tuple<T...> operator *(const Scalar& lhs, const arithmetic_tuple<T...>& rhs) {
		  arithmetic_tuple<T...> result;
		  detail::tuple_smul_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>,Scalar>(result, lhs, rhs);
		  return result;
	       };
   ...
   template <typename... T, typename Scalar>
      arithmetic_tuple<T...> operator /(const arithmetic_tuple<T...>& lhs, const Scalar& rhs) {
		  arithmetic_tuple<T...> result;
		  detail::tuple_divs_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>,Scalar>(result, lhs, rhs);
		  return result;
	       };
   ...
   template <typename... T, typename Scalar>
      arithmetic_tuple<T...> operator +(const arithmetic_tuple<T...>& lhs, const Scalar& rhs) {
		  arithmetic_tuple<T...> result;
		  detail::tuple_adds_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>,Scalar>(result, lhs, rhs);
		  return result;
	       };
   ...
   template <typename... T, typename Scalar>
      arithmetic_tuple<T...> operator +(const Scalar& lhs, const arithmetic_tuple<T...>& rhs) {
		  arithmetic_tuple<T...> result;
		  detail::tuple_sadd_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>,Scalar>(result, lhs, rhs);
		  return result;
	       };
    ...
    */  
   template <typename... T>
      arithmetic_tuple<T...> abs(const arithmetic_tuple<T...>& tpl) {
		  arithmetic_tuple<T...> result;
		  detail::tuple_abs_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>>(result, tpl);
		  return result;
	       };
   ...
   template <typename... T>
      arithmetic_tuple<T...>& operator *=(arithmetic_tuple<T...>& lhs, const arithmetic_tuple<T...>& rhs) {
		  detail::tuple_mulassign_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>>(lhs, rhs);
		  return lhs;
	       };
   ...
   template <typename... T>
      arithmetic_tuple<T...>& operator /=(arithmetic_tuple<T...>& lhs, const arithmetic_tuple<T...>& rhs) {
		  detail::tuple_divassign_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>>(lhs, rhs);
		  return lhs;
	       };
    ...
    */  
   template <typename... T, typename Scalar>
      arithmetic_tuple<T...>& operator *=(arithmetic_tuple<T...>& lhs, const Scalar& rhs) {
		  detail::tuple_smulassign_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>,Scalar>(lhs, rhs);
		  return lhs;
	       };
   ...
   template <typename... T, typename Scalar>
      arithmetic_tuple<T...>& operator /=(arithmetic_tuple<T...>& lhs, const Scalar& rhs) {
		  detail::tuple_sdivassign_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>,Scalar>(lhs, rhs);
		  return lhs;
	       };
   ...
   template <typename... T, typename Scalar>
      arithmetic_tuple<T...>& operator +=(arithmetic_tuple<T...>& lhs, const Scalar& rhs) {
		  detail::tuple_saddassign_impl<arithmetic_tuple_size<arithmetic_tuple<T...>>,arithmetic_tuple<T...>,Scalar>(lhs, rhs);
		  return lhs;
	       };
    ...
    */  
   template <typename... T>
      typename boost::enable_if< is_arithmetic_tuple<arithmetic_tuple<T...>>,
	       std::ostream& >::type operator <<(std::ostream& out, const arithmetic_tuple<T...>& rhs) {
		  detail::tuple_std_output_impl<typename boost::mpl::prior< arithmetic_tuple_size<arithmetic_tuple<T...>> >::type, arithmetic_tuple<T...>>(out,rhs);
		  return out << ")";
	       };
